...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget musicPlay() {
      Widget musicPlay(String img, String text, String subText) {
        return Container(
          width: 142,
          margin: const EdgeInsets.only(right: 16),
          child: Column(
          ...
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                ...
                musicPlay("assets/img-music21.png", "Daily Mix",
                    "Jonas Blue, NOTD, David Guetta and more"),
                musicPlay("assets/img-music22.png", "Feelin’ Myself",
                    "Ariana Grande, Doja Cat, Megan Thee Stallion..."),
                musicPlay("assets/img-music23.png", "Mood Booster",
    ...
    Widget musicPopular() {
      Widget musicPopular(String img, String text, String subText) {
        return Container(
          width: 142,
          margin: const EdgeInsets.only(right: 16),
          child: Column(
          ...
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                ...
                musicPopular("assets/img-music12.png", "Good Vibes",
                    "Tame Impala, Joji, Tyler, The Creator, 5 Second"),
                musicPopular("assets/img-music13.png", "Mega Hit Mix",
                    "Ariana Grande, BTS, Dua Lipa, Justin Bieber, Taylo"),
                musicPopular("assets/img-music14.png", "Young & Free",
